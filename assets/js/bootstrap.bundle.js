...
function tinh_nang_chua_mo() {
  alert("Tính năng chưa mở.")
}

function khieu_nai_gop_y() {
  var get = document.querySelector("#kn-gy")
  get.style.display="block"
  get.setAttribute("src", "https://docs.google.com/forms/d/e/1FAIpQLSdA6gvibX0IzaeeQ2vPEzdWVCT87rFyvbyZZr2LP6dYWv81hQ/viewform?embedded=true")
  get.setAttribute("style", "width: 100%; height: 80vh")
  var get_btn = document.querySelector("#kn-gy-btn")
  get_btn.innerText = "Đóng"
  get_btn.setAttribute("onclick", "close_kn_gy()")
}

function close_kn_gy()
{
  var get = document.querySelector("#kn-gy")
  get.style.display="none"
  var get_btn = document.querySelector("#kn-gy-btn")
  get_btn.innerText = "Khiếu nại, góp ý."
  get_btn.setAttribute("onclick", "khieu_nai_gop_y()")
}

function this_page_is_light_theme() { var check = confirm("trang mà bạn sắp truy cập ở chế dộ sáng"); if (check == true) { window.location.replace("/about-this-web") } }