// check mobile or pc
var isMobile = false
var widthSize = window.matchMedia("(max-width:1024px)")
...
// khu vuon ngon tu (m013)

var api_m013 = `{"status":true,"msg":"","movie":{"modified":{"time":"2022-03-01T14:47:38.451Z"},"_id":"621e320a3fb21848d1974c52","name":"Khu vườn ngôn từ","origin_name":"The Garden of Words","content":"<p>Một thiếu niên tuổi teen cô đơn cúp học buổi sáng để đến một khu vườn xinh đẹp. Tại đó, cậu gặp một phụ nữ lớn tuổi hơn, đầy bí ẩn và có cùng cảm giác tách biệt.</p>","type":"single","status":"completed","thumb_url":"https://img.hiephanhthienha.com/uploads/movies/khu-vuon-ngon-tu-thumb.jpg","is_copyright":"off","trailer_url":"","time":"46ph","episode_current":"Full","episode_total":"1","quality":"HD","lang":"Vietsub","notify":"","showtimes":"","slug":"khu-vuon-ngon-tu","year":2013,"actor":["Irino Miyu","Hanazawa Kana","Hirano Fumi"],"director":[""],"category":[{"name":"Chính kịch"}],"country":[{"name":"Nhật Bản"}],"chieurap":false,"poster_url":""},"episodes":[{"server_name":"Vietsub #1","server_data":[{"name":"Full","slug":"full","filename":"Khu vườn ngôn từ","link_embed":"https://kd.hd-bophim.com/share/4c5bde74a8f110656874902f07378009","link_m3u8":"https://kd.hd-bophim.com/20220301/182_fde20ef4/index.m3u8"}]}]}`
var api_m013_parse = JSON.parse(api_m013)

function m013() {
    var tap = 1;
    var getTap = api_m013_parse.episodes[0].server_data[tap - 1].name
    var getSubName = api_m013_parse.episodes[0].server_data[tap - 1].filename
    var getLink = api_m013_parse.episodes[0].server_data[tap - 1].link_embed
    var getBtn = document.querySelectorAll(`.btn-controller-${tap}`)
    var getMovieScreen = document.querySelectorAll(`.movie-screen`)
    var getMovieEpisode = document.querySelectorAll(`.movie-episode`)
    var getMovieSubName = document.querySelectorAll('.movie-sub-name')
...
// khu rung dom dom (m014)

var api_m014 = `{"status":true,"msg":"","movie":{"modified":{"time":"2022-03-01T14:47:38.451Z"},"_id":"621e320a3fb21848d1974c52","name":"Khu vườn ngôn từ","origin_name":"The Garden of Words","content":"<p>Một thiếu niên tuổi teen cô đơn cúp học buổi sáng để đến một khu vườn xinh đẹp. Tại đó, cậu gặp một phụ nữ lớn tuổi hơn, đầy bí ẩn và có cùng cảm giác tách biệt.</p>","type":"single","status":"completed","thumb_url":"https://img.hiephanhthienha.com/uploads/movies/khu-vuon-ngon-tu-thumb.jpg","is_copyright":"off","trailer_url":"","time":"46ph","episode_current":"Full","episode_total":"1","quality":"HD","lang":"Vietsub","notify":"","showtimes":"","slug":"khu-vuon-ngon-tu","year":2013,"actor":["Irino Miyu","Hanazawa Kana","Hirano Fumi"],"director":[""],"category":[{"name":"Chính kịch"}],"country":[{"name":"Nhật Bản"}],"chieurap":false,"poster_url":""},"episodes":[{"server_name":"Vietsub #1","server_data":[{"name":"Full","slug":"full","filename":"Khu vườn ngôn từ","link_embed":"https://kd.hd-bophim.com/share/4c5bde74a8f110656874902f07378009","link_m3u8":"https://kd.hd-bophim.com/20220301/182_fde20ef4/index.m3u8"}]}]}`
var api_m014_parse = JSON.parse(api_m014)

function m014() {
    var tap = 1;
    var getTap = api_m014_parse.episodes[0].server_data[tap - 1].name
    var getSubName = api_m014_parse.episodes[0].server_data[tap - 1].filename
    var getLink = api_m014_parse.episodes[0].server_data[tap - 1].link_embed
    var getBtn = document.querySelectorAll(`.btn-controller-${tap}`)
    var getMovieScreen = document.querySelectorAll(`.movie-screen`)
    var getMovieEpisode = document.querySelectorAll(`.movie-episode`)
    var getMovieSubName = document.querySelectorAll('.movie-sub-name')
...
// cong tuoc tu thna va co hau (m015)
var api_m015 = `{"status":true,"msg":"","movie":{"modified":{"time":"2022-08-09T13:28:20.000Z"},"_id":"625af6a6941a26e421dc0f09","name":"Công tước tử thần và cô hầu","origin_name":"Shinigami Bocchan to Kuro Maid, The Duke of Death and His Maid","content":"<p>Bị nguyền rủa từ nhỏ, một công tước trẻ nhận được thứ sức mạnh không hề mong muốn là giết hết mọi thứ mà cậu ta chạm vào. Bị buộc phải cách xa gia đình và sống ở một dinh thự sâu trong rừng, cậu bị đối xử như thể không có tồn tại và tiếp tục bị mọi người xa lánh. Tuy nhiên cậu không chỉ một mình. Rob và Alice là quản gia và người hầu luôn ở bên cạnh cậu ta. Alice thích trêu chọc cậu, và dần dà mối quan hệ giữa hai người phát triển, cậu công tước trẻ muốn phá bỏ lời nguyền chết chóc của mình. Để giải được lời nguyền ấy, cậu sẽ cần đến sự trợ giúp từ những người bạn với sức mạnh siêu nhiên.</p>","type":"hoathinh","status":"completed","thumb_url":"https://img.hiephanhthienha.com/uploads/movies/cong-tuoc-tu-than-va-co-hau-thumb.jpg","is_copyright":"off","sub_docquyen":"off","trailer_url":"https://www.bilibili.tv/vi/video/2009095884","time":"24 phút/tập","episode_current":"Hoàn Tất (12/12)","episode_total":"12 Tập","quality":"HD","lang":"Vietsub","notify":"","showtimes":"","slug":"cong-tuoc-tu-than-va-co-hau","year":2021,"actor":[""],"director":[""],"category":[{"name":"Tình Cảm"}],"country":[{"name":"Nhật Bản"}],"chieurap":false,"poster_url":"https://img.hiephanhthienha.com/uploads/movies/cong-tuoc-tu-than-va-co-hau-poster.jpg"},"episodes":[{"server_name":"Vietsub #1","server_data":[{"name":"1","slug":"1","filename":"Công tước tử thần và cô hầu Tập 1 - Cậu chủ và AliceTập 1","link_embed":"https://kd.hd-bophim.com/share/0b3c45f91691dcc98754d33374db0300","link_m3u8":"https://kd.hd-bophim.com/20220809/19846_00ce2a24/index.m3u8"},{"name":"2","slug":"2","filename":"Công tước tử thần và cô hầu Tập 2 - Cậu chủ, quản gia và con mèo đi lạc","link_embed":"https://kd.hd-bophim.com/share/083b65c888b720c920dcaead304c5989","link_m3u8":"https://kd.hd-bophim.com/20220416/8060_b13eddff/index.m3u8"},{"name":"3","slug":"3","filename":"Công tước tử thần và cô hầu Tập 3 - Cậu chủ và trăng tròn cùng cơn mưa sao băng","link_embed":"https://kd.hd-bophim.com/share/8f4d94fa779cb6b74225a9e26c700a39","link_m3u8":"https://kd.hd-bophim.com/20220416/8061_0899ea17/index.m3u8"},{"name":"4","slug":"4","filename":"Công tước tử thần và cô hầu Tập 4 - Cậu chủ, Alice và kí ức về tuyết","link_embed":"https://kd.hd-bophim.com/share/ee492a6c8f567fb3100b7dc9d3600cbe","link_m3u8":"https://kd.hd-bophim.com/20220416/8062_32b701b0/index.m3u8"},{"name":"5","slug":"5","filename":"Công tước tử thần và cô hầu Tập 5 - Cậu chủ, con quạ và trượt băng","link_embed":"https://kd.hd-bophim.com/share/8d1f1aac0dd8a76b49e8bbdda0c7c98c","link_m3u8":"https://kd.hd-bophim.com/20220416/8063_9fc19e46/index.m3u8"},{"name":"6","slug":"6","filename":"Công tước tử thần và cô hầu Tập 6 - Cậu chủ, Alice và đêm trong quỷ giới","link_embed":"https://kd.hd-bophim.com/share/320e4df890a1a620573db8170f39a093","link_m3u8":"https://kd.hd-bophim.com/20220416/8065_69049a4e/index.m3u8"},{"name":"7","slug":"7","filename":"Công tước tử thần và cô hầu Tập 7 - Một ngày bình thường của cậu chủ và Alice","link_embed":"https://kd.hd-bophim.com/share/fa40b3850046b362217c121a274720fd","link_m3u8":"https://kd.hd-bophim.com/20220416/8064_d5a5a965/index.m3u8"},{"name":"8","slug":"8","filename":"Công tước tử thần và cô hầu Tập 8 - Tuyết trắng, trang phục đen","link_embed":"https://kd.hd-bophim.com/share/8b519f198dd26772e3e82874826b04aa","link_m3u8":"https://kd.hd-bophim.com/20220416/8066_772d2783/index.m3u8"},{"name":"9","slug":"9","filename":"Công tước tử thần và cô hầu Tập 9 - Cậu chủ và Alice và đêm thề nguyện Giáng Sinh","link_embed":"https://kd.hd-bophim.com/share/53253027fef2ab5162a602f2acfed431","link_m3u8":"https://kd.hd-bophim.com/20220416/8067_d55f14d4/index.m3u8"},{"name":"10","slug":"10","filename":"Công tước tử thần và cô hầu Tập 10 - Cậu chủ và Alice và bản nhạc chỉ dành cho hai người","link_embed":"https://kd.hd-bophim.com/share/a7d9277053b8355e69db079f52d274e9","link_m3u8":"https://kd.hd-bophim.com/20220416/8068_95395d3f/index.m3u8"},{"name":"11","slug":"11","filename":"Công tước tử thần và cô hầu Tập 11 - Cậu chủ và bí mật của ma thuật","link_embed":"https://kd.hd-bophim.com/share/d5c8e1ab6fc0bfeb5f29aafa999cdb29","link_m3u8":"https://kd.hd-bophim.com/20220416/8070_5c9b8a92/index.m3u8"},{"name":"12","slug":"12","filename":"Công tước tử thần và cô hầu Tập 12 - Cùng với cậu chủ…","link_embed":"https://kd.hd-bophim.com/share/7cc5a75432e9a547200e3668c3761ae7","link_m3u8":"https://kd.hd-bophim.com/20220416/8069_455821ed/index.m3u8"}]}]}`
var api_m015_parse = JSON.parse(api_m015)

function m015_p1_t1() {
    // console.log("Hello world")
    var tap = 1;
    var getTap = api_m015_parse.episodes[0].server_data[tap - 1].name
    var getSubName = api_m015_parse.episodes[0].server_data[tap - 1].filename
    var getLink = api_m015_parse.episodes[0].server_data[tap - 1].link_embed
    var getBtn = document.querySelectorAll(`.btn-controller-${tap}`)
    var getMovieScreen = document.querySelectorAll(`.movie-screen`)
    var getMovieEpisode = document.querySelectorAll(`.movie-episode`)
    var getMovieSubName = document.querySelectorAll('.movie-sub-name')
...
// dang hinh thanh am (m016)

var api_m016 = `{"status":true,"msg":"","movie":{"modified":{"time":"2022-03-18T11:19:43.954Z"},"_id":"62346acf3c735a9a446e233c","name":"Dáng Hình Thanh Âm","origin_name":"A Silent Voice","content":"<p>Một chàng trai trẻ bị các bạn cùng lớp bị tẩy chay sau khi anh ta bắt nạt một cô gái điếc đến mức cô di chuyển đi. Nhiều năm sau, anh đặt ra một con đường để cứu chuộc.</p>","type":"hoathinh","status":"completed","thumb_url":"https://img.hiephanhthienha.com/uploads/movies/dang-hinh-thanh-am-thumb.jpg","is_copyright":"off","trailer_url":"","time":"","episode_current":"Full","episode_total":"1","quality":"HD","lang":"Vietsub","notify":"","showtimes":"","slug":"dang-hinh-thanh-am","year":2016,"actor":[""],"director":[""],"category":[{"name":"Kinh Dị"}],"country":[{"name":"Nhật Bản"}],"chieurap":false,"poster_url":""},"episodes":[{"server_name":"Vietsub #1","server_data":[{"name":"1","slug":"1","filename":"Dáng Hình Thanh Âm","link_embed":"https://hd.1080phim.com/share/a60937eba57758ed45b6d3e91e8659f3","link_m3u8":"https://hd.1080phim.com/20220316/1415_01d25c2b/index.m3u8"}]}]}`
var api_m016_parse = JSON.parse(api_m016)

function m016() {
    var tap = 1;
    var getTap = api_m016_parse.episodes[0].server_data[tap - 1].name
    var getSubName = api_m016_parse.episodes[0].server_data[tap - 1].filename
    var getLink = api_m016_parse.episodes[0].server_data[tap - 1].link_embed
    var getBtn = document.querySelectorAll(`.btn-controller-${tap}`)
    var getMovieScreen = document.querySelectorAll(`.movie-screen`)
    var getMovieEpisode = document.querySelectorAll(`.movie-episode`)
    var getMovieSubName = document.querySelectorAll('.movie-sub-name')
...
// hoi uc khong quen (m017)
var api_urls = `https://ophim1.com/phim/violet-evergarden-hoi-uc-khong-quen`
...
function m017() {
    ...
    fetch(api_urls)
        ...
        .then(function (content) {
            var getBtn = document.querySelectorAll(`.btn-controller-${tap}`)
            var getMovieScreen = document.querySelectorAll(".movie-screen")
            var getSubName = document.querySelectorAll(".movie-sub-name")
            var get_episode = document.querySelectorAll(".movie-episode")

            var get_sub_name = content.episodes[0].server_data[tap - 1].filename
            var get_link = content.episodes[0].server_data[tap - 1].link_embed
            var get_tap = content.episodes[0].server_data[tap - 1].name

            if (isMobile == false) {
                getMovieScreen[0].setAttribute("src", get_link)
                getBtn[0].className = `btn btn-success btn-controller-${tap} active`
                get_episode[0].innerText = get_tap
                getSubName[0].innerText = get_sub_name
            }

            else if (isMobile == true) {
                getMovieScreen[1].setAttribute("src", get_link)
                getBtn[1].className = `btn btn-success btn-controller-${tap} active`
                get_episode[1].innerText = get_tap
                getSubName[1].innerText = get_sub_name
            }
        })
}

// hau gai rong nha kobayashi (m018) part 1
var api_urls_m018_p1 = `https://ophim1.com/phim/hau-gai-rong-nha-kobayashi`

function m018_p1_t1() {
    var tap = 1
    fetch(api_urls_m018_p1)
        .then(function (response) {
            return response.json()
        })
...
// hau gai rong nha kobayashi (m18) part 2
var api_urls_m018_p2 = `https://ophim1.com/phim/hau-gai-rong-nha-kobayashi-s`

function m018_p2_t1() {
    var tap = 1
    fetch(api_urls_m018_p2)
        .then(function (response) {
            return response.json()
        })
...
var api_urls_m020_p1 = `https://ophim1.com/phim/blue-lock`

function m020_p1_t1() {
    var tap = 1
    fetch(api_urls_m020_p1)
        .then(function (response) {
            return response.json()
        })
...
// Himouto! Umaru-chan (m019)
var api_urls_m019_p1 = `https://ophim1.com/phim/himouto-umaru-chan-co-em-gai-hai-mat`

function m019_p1_t1() {
    var tap = 1
    fetch(api_urls_m019_p1)
        .then(function (response) {
            return response.json()
        })
...
// Himouto! Umaru-chan (m019)
var api_urls_m019_p2 = `https://ophim1.com/phim/himouto-umaru-chan-co-em-gai-hai-mat-r`

function m019_p2_t1() {
    var tap = 1
    fetch(api_urls_m019_p2)
        .then(function (response) {
            return response.json()
        })
