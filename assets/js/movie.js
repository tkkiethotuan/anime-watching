...
function m017() {
    ...
    fetch (api_urls) 
        ...
        .then (function(content) {
            var get_btn = document.querySelectorAll(`.btn-controller-${tap}`)
            var get_movie_screen = document.querySelectorAll(".movie-screen")
            var get_sub_name = document.querySelectorAll(".movie-sub-name")
            var get_tap = document.querySelectorAll(".movie-episode")
            ...
            if (isMobile == false) {
                get_movie_screen[0].setAttribute("src", get_link)
                get_btn[0].className = `btn btn-success btn-controller-${tap} active`
                get_tap[0].innerText = get_tap
                get_sub_name[0].innerText = get_sub_name
            }
        
            else if (isMobile == true) {
                get_movie_screen[1].setAttribute("src", get_link)
                get_btn[1].className = `btn btn-success btn-controller-${tap} active`
                get_tap[1].innerText = get_tap
                get_sub_name[1].innerText = get_sub_name
            }
        })
}

// hau gai rong nha kobayashi (m018) part 1
var api_urls = `https://ophim1.com/phim/hau-gai-rong-nha-kobayashi`
